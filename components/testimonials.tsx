...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "TradeChain simplifies our international transactions, ensuring security and efficiency. It's a vital part of our supply chain process.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "We rely on TradeChain for secure and transparent trading. The real-time insights help us make faster decisions with confidence.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "TradeChain's seamless integration with our operations has reduced delays and boosted overall efficiency in our commodity trades.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "The platform’s tokenization and secure transactions have optimized our cross-border commodity trades. TradeChain is reliable and fast.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "TradeChain makes our sourcing process simple and transparent. It's an essential tool for maintaining our global supply chain.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "TradeChain provides the security and speed needed for complex trades. It's the backbone of our trading strategy.",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "The platform's transparency and real-time tracking help us trade efficiently. TradeChain is at the core of our secure trading ecosystem.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "TradeChain has transformed how we trade commodities. The platform is secure, fast, and incredibly user-friendly.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "The reliability of TradeChain ensures smooth commodity trading across borders. It’s a crucial part of our operations.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Leading companies across the globe trust TradeChain for secure, transparent, and efficient commodity trading. Here's what they have to say about our platform.
          </p>
        </div>
